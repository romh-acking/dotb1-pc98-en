(mes
 ...
 (seg (? (= Q 10) (= 0 #f))
   (proc 0)
   (str
    "On one hand, I could wait here until a zombie comes  over, but Sheila's waiting, so I better hurry.")
   (proc 3))
 (seg (? (= Q 11) (= 0 #f) (= 52 #f))
   (proc 0)
   (str
    "There's blood on the floor. I don't see any zombies, so I don't know if one's lurking nearby...")
   (set-reg 52 #t)
   (proc 3))
 (seg (? (= Q 11) (= 0 #f) (= 53 #f))
   (proc 0)
 ...
 (seg (? (= Q 11) (= 0 #f))
   (proc 0)
   (str "There's a lot of boxes and zombie blood on the       concrete floor.")
   (proc 3))
 (seg (? (= Q 12) (= 0 #f) (= 54 #f))
   (proc 0)
   (str
    "There's a power cord on the ceiling for lights. If   construction was done, there'd probably be light here.")
   (set-reg 54 #t)
   (proc 3))
 (seg (? (= Q 12) (= 0 #f) (= 55 #f))
   (proc 0)
 ...
 (seg (? (= Q 13) (= 0 #f) (= 56 #f))
   (proc 0)
   (str
    "I feel a stiff cool breeze from the window. It's muchcolder here than the other rooms.")
   (set-reg 56 #t)
   (proc 3))
 (seg (? (= Q 13) (= 0 #f) (= 57 #f))
   (proc 0)
   (str
    "It's cloudy. If it rains tomorrow, it'll be tougher  to deal with zombies outside.")
   (set-reg 57 #t)
   (proc 3))
 (seg (? (= Q 13) (= 0 #f))
   (proc 0)
   (str
    "There's no power in the surrounding buildings. The   whole city went dark...")
   (proc 3))
 (seg (? (= Q 6) (= 0 #t))
