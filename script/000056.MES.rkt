(mes
 ...
 (seg*
  ...
  ((cmd 197) 0 0)
  ((cmd 197) 1 0)
  (image-file "A:¥GRAPH¥BL092.GPC") (image-mem 1 1)
  (if (</>
 ...
 (seg (? (= Q 9) (= 0 #f) (= 1 #t) (= 10 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "There's some rubble blocking the steps. I can't go up" 'br)
   (str "now.")
   (set-reg 10 #t)
   (proc 3))
 (seg (? (= Q 9) (= 0 #f) (= 1 #t) (= 11 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "Looks like some rubble collapsed on the second floor." 'br)
   (str "I can't get past it now.")
   (set-reg 11 #t)
   (proc 3))
 (seg (? (= Q 9) (= 0 #f) (= 1 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (str "If this rubble drops, it'll be dangerous for anyone" 'br)
   (str "near the stairs.")
   (proc 3))
 ...
 (seg (? (= Q 9) (= 0 #t) (= 1 #f) (= 52 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (str "I have to go upstairs, but I can't move this rubble" 'br)
   (str "away.")
   (proc 3))
 (seg (? (= Q 9) (= 0 #t) (= 1 #f) (= 12 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "No good. There's too much rubble for me to move" 'br)
   (str "alone.")
   (set-reg 12 #t)
   (proc 3))
 (seg (? (= Q 9) (= 0 #t) (= 1 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "No matter how much I try, this rubble is impossible" 'br)
   (str "to move.")
   (proc 3))
 ...
 (seg (? (= Q 10) (= 0 #f) (= 1 #t) (= 14 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "This elevator doesn't work. The only way up is those" 'br)
   (str "stairs.")
   (set-reg 14 #t)
   (proc 3))
 (seg (? (= Q 10) (= 0 #f) (= 1 #t))
 ...
 (seg (? (= Q 11) (= 0 #t) (= 1 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "No matter how many times I press it, the elevator" 'br)
   (str "isn't coming.")
   (proc 3))
 ...
 (seg (? (= Q 12) (= 0 #f) (= 1 #t) (= 17 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "There aren't any bullet holes in the walls. If the" 'br)
   (str "others were here, surely there would've been shots fired," 'br)
   (str "right?")
   (set-reg 17 #t)
   (proc 3))
 (seg (? (= Q 12) (= 0 #f) (= 1 #t))
 ...
 (seg (? (= Q 13) (= 0 #f) (= 1 #t) (= 24 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (str "I don't think those people were killed by zombies. It" 'br)
   (str "must've been Killer's work.")
   (proc 3))
 ...
 (seg (? (= Q 13) (= 0 #f) (= 1 #t) (= 19 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "This office door seems unlocked. Hopefully, no dead" 'br)
   (str "inside.")
   (set-reg 19 #t)
   (proc 3))
 (seg (? (= Q 13) (= 0 #f) (= 1 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (str "They were all supposed to be here, so I have to check" 'br)
   (str "all rooms, not just this office.")
   (proc 3))
 (seg (? (= Q 14) (= 0 #f) (= 1 #t) (= 20 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "It's a vending machine. You put in some money, and" 'br)
   (str "you get a drink.")
   (set-reg 20 #t)
   (proc 3))
 (seg (? (= Q 14) (= 0 #f) (= 1 #t) (= 21 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "This is useless. I don't have time to dick around. I" 'br)
   (str "gotta get to Killer as fast as possible.")
   (set-reg 21 #t)
   (proc 3))
 (seg (? (= Q 14) (= 0 #f) (= 1 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (str "Doesn't seem to work now. I don't hear a motor or" 'br)
   (str "anything.")
   (proc 3))
 ...
 (seg (? (= Q 9) (= 0 #t) (= 1 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (str "The rubble's in the way so it's impossible to get" 'br)
   (str "upstairs.")
   (proc 3))
 (seg (? (= Q 10) (= 0 #t) (= 1 #t) (= 23 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "The elevator doesn't work. It's stopped, and the door" 'br)
   (str "won't open.")
   (set-reg 23 #t)
   (proc 3))
 (seg (? (= Q 10) (= 0 #t) (= 1 #t))
 ...
 (seg (? (= Q 13) (= 0 #t) (= 1 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (str "This is an office. I have to be careful. There could" 'br)
   (str "be zombies nearby.")
   (set-reg 24 #t)
   (proc 3)
   ((cmd 198) 32 5 127 66 0)
   (mes-jump "A:¥MES¥000057.MES"))
 (seg (? (= Q 5) (= 0 #f) (= 1 #f))
   ...
   (if (</>
        (//
         (? (= T 0) (= 27 #f))
         (proc 4) (str "Cole: ") (proc 0)
          (str "I think a grenade would be dangerous here. I'd better" 'br)
   (str "use something else.")
         (proc 3))
        (//
         (? (= T 0))
         (proc 4) (str "Cole: ") (proc 0)
          (str "I better hold onto the grenade in case I need it" 'br)
   (str "later.")
         (proc 3))
        (//
         (? (= T 1) (= 27 #t))
         (proc 4) (str "Cole: ") (proc 0)
          (str "No need to use this gun anymore. I better save the" 'br)
   (str "ammo.")
         (proc 3))
