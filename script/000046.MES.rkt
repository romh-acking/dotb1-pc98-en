(mes
 ...
 (seg*
  ...
  (if (</>
       (//
        (? (= 30 #f))
        (proc 2)
        (str "This room has that unmistakable Cooger scent.")
        (set-reg 30 #t)
        (proc 3))
       (//
        (proc 0)
 ...
 (seg (? (= Q 10) (= 0 #f) (= 35 #f))
   ...
   (if (</>
        (//
         (? (= 76 #f))
         (proc 2)
         (str "Nothing seems to be able to use that key.")
         (proc 3))))
   (set-reg 35 #t))
 (seg (? (= Q 10) (= 0 #f) (= 36 #f))
   (proc 2)
   ...
   (if (</>
        (//
         (? (= 76 #t))
         (text "　")
         (str "Is there a note with the code on it?")
         (text "　")
         (proc 3)
         (proc 0)
         (text "　")
         (str "No, if it was a code, Doc would've memorized it.")
         (text "　"))
        (//
         (text "　")
 ...
 (seg (? (= Q 10) (= 0 #f))
   ...
   (proc 2)
   (str
    "There are some formulas in the notebook but I don'tunderstand any of them.")
   (proc 3))
 (seg (? (= Q 11) (= 0 #f) (= 37 #f))
   (proc 0)
   (str "A chair")
 ...
 (seg (? (= Q 11) (= 0 #f) (= 38 #f))
   (proc 2)
   (str
    "Just a normal chair. I can't find anything         important about it.")
   (set-reg 38 #t)
   (proc 3))
 (seg (? (= Q 11) (= 0 #f))
   (proc 0)
   ...
   (proc 3))
 (seg (? (= Q 12) (= 0 #f) (= 39 #f) (= 47 #f))
   (proc 0)
   (str "How odd. This bookshelf only has some novels.")
   (proc 3)
   (proc 2)
   (str "I know some of these novels here!")
   (set-reg 39 #t)
   (proc 3))
 (seg (? (= Q 12) (= 0 #f) (= 40 #f) (= 47 #f))
   (proc 0)
   (str
    "It's tricky to know what these books are about from  the title alone.")
   (proc 3)
   (proc 2)
   (str "You should read more, Cole.")
   (set-reg 40 #t)
   (proc 3))
 (seg (? (= Q 12) (= 0 #f) (= 47 #f))
   (proc 0)
 ...
 (seg (?
   ...
   (image-mem 1 1)
   (proc 2)
   (str "Cole, I think something fell beside the bed.")
   (proc 3)
   (proc 0)
 ...
 (seg (? (= Q 13) (= 0 #f) (= 42 #f))
   ...
   (proc 3)
   (proc 2)
   (str "Right, he'd always get worn out and fall asleep in the lab.")
   (set-reg 42 #t)
   (proc 3))
 (seg (? (= Q 13) (= 0 #f))
   (proc 0)
 ...
 (seg (? (= Q 12) (= 0 #f) (= 47 #t) (= 49 #f) (= 53 #f))
   ...
   (proc 3)
   (proc 2)
   (str "It looks like Mr. Cooger was in his 30s when this  was taken.")
   (set-reg 49 #t)
   (proc 3))
