(mes
 ...
 (seg*
  ...
  (if (</>
       ...
       (//
        ...
        (proc 0)
        (str
         "Doc was such a research enthusiast. He documented    every little point in his files!")
        (proc 3))))
  (if (</>
 ...
 (seg (? (= Q 10) (= 0 #f) (= 1 #t))
   ...
   (proc 3)
   (proc 2)
   (str "If it's in this study, it must've been important tohim.")
   (proc 3))
 ...
 (seg (? (= Q 11) (= 0 #f) (= 1 #t) (= 64 #f))
   ...
   (proc 0)
   (str
    "It's probably just a tree. That's the garden and     there's a lot of trees there.")
   (set-reg 64 #t)
   (proc 3))
 (seg (? (= Q 11) (= 0 #f) (= 1 #t))
   (proc 0)
   ...
   (proc 3)
   (proc 2)
   (str "Yeah, it stopped already. It was probably just a   light shower.")
   (proc 3))
 ...
 (seg (? (= Q 15) (= 0 #f) (= 1 #t) (= 74 #f) (= 72 #f))
   ...
   (proc 2)
   (str
    "The page describes the human brain in as much      detail as possible.")
   (set-reg 74 #t)
   (proc 3))
 ...
 (seg (? (= Q 15) (= 0 #t) (= 1 #f) (= 72 #t) (= 75 #t) (= 76 #f))
   ...
   (proc 3)
   (proc 2)
   (str "It's a passcode keypad, like the one at the hotel'sentrance.")
   (proc 3)
   (proc 2)
