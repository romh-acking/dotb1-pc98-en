(mes
 ...
 (seg*
  ...
  (image-file "A:¥GRAPH¥BL026.GPC") (image-mem 1 1)
  (if (</>
       (//
        (? (= 14 #f))
  ...
  (if (</>
       (//
        (? (= 14 #t))
        (image-file "A:¥GRAPH¥BL027.GPC") (image-mem 1 0)
 ...
 (seg (? (= Q 9) (= 0 #f) (= 1 #t) (= 10 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "Covers for the construction work are blowing in the" 'br)
   (str "wind. They seem to be calling to me.")
   (set-reg 10 #t)
   (proc 3))
 (seg (? (= Q 9) (= 0 #f) (= 1 #t) (= 11 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "Construction isn't finished, seems it'll take a few" 'br)
   (str "more months.")
   (proc 19)
   (proc 4) (str "Sheila: ") (proc 2)
      (str "It looks creepy.")
   (proc 3)
   (proc 4) (str "Cole: ") (proc 0)
    (str "It's alright. There are probably dozens of refugees" 'br)
   (str "in here.")
   (set-reg 11 #t)
   (proc 3))
 (seg (? (= Q 9) (= 0 #f) (= 1 #t))
   (proc 4) (str "Cooger: ") (proc 1)
      (str "A major construction company's logo is on the" 'br)
   (str "construction tarp.")
   (proc 3))
 ...
 (seg (? (= Q 10) (= 0 #f) (= 1 #t) (= 13 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "This hotel looks pretty swank. My budget only" 'br)
   (str "stretches to the crappiest motor inns.")
   (set-reg 13 #t)
   (proc 3))
 (seg (? (= Q 10) (= 0 #f) (= 1 #t))
   (proc 4) (str "Cole: ") (proc 0)
 ...
 (seg (? (= Q 10) (= 0 #t) (= 1 #t) (= 14 #f))
   ...
   (proc 3)
   (proc 4) (str "Cooger: ") (proc 1)
      (str "Hmm? Cole, the door's locked. Did you find a key at" 'br)
   (str "the station?")
   (proc 19)
   (proc 4) (str "Cole: ") (proc 0)
   ...
   (proc 19)
   (proc 4) (str "Cole: ") (proc 0)
    (str "Punch in the right code and you can enter? How" 'br)
   (str "modern.")
   (set-reg 14 #t)
   (proc 3)
   (exec-mem 16384 0 0 1 1)
 ...
 (seg (? (= Q 11) (= 0 #t) (= 1 #f))
   ...
   (branch-var
    ...
    (</>
     ...
     (/ (proc 4) (str "Cole: ") (proc 0) (str "I have to input a number") (str "."))))
   (proc 3))
 (seg (? (= Q 8))
