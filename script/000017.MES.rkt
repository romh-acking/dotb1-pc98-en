(mes
 ...
 (seg*
  ...
  (proc 4) (str "Sheila: ") (proc 2)
     (str "It's so close to the stairs, I'm a bit worried" 'br)
   (str "about that.")
  (proc 3)
  (if (</>
 ...
 (seg (? (= Q 10) (= 0 #f) (= 10 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "Even though it's the 3rd floor, we're quite high up." 'br)
   (str "If I fell from here, I'd be street pizza.")
   (set-reg 10 #t)
   (proc 3))
 (seg (? (= Q 10) (= 0 #f))
   (proc 4) (str "Sheila: ") (proc 2)
 ...
 (seg (? (= Q 12) (= 0 #f) (= 14 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "I have to make sure I don't lose this card. There's" 'br)
   (str "probably not a spare.")
   (set-reg 14 #t)
   (proc 3))
 (seg (? (= Q 12) (= 0 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "I don't need a PIN. I know 216 is the entrance, but" 'br)
   (str "it's hard to remember 2 passcodes at once.")
   (proc 3))
 (seg (? (= Q 13) (= 0 #f))
   (proc 4) (str "Cole: ") (proc 0)
   ...
   (proc 3)
   (proc 4) (str "Sheila: ") (proc 2)
      (str "So this is how you open the door. You slide the" 'br)
   (str "card in.")
   (proc 3))
 (seg (? (= Q 5) (= 0 #t))
   (menu1
     ...
     (/
      (branch-random
       (</>
        (/
         (proc 4) (str "Cooger: ") (proc 1)
            (str "This is dangerous. I don't think we should have" 'br)
   (str "such noisy things here.")
         (proc 3))
        (/
         (proc 4) (str "Cole: ") (proc 0)
     ...
     (/ (proc 4) (str "Cole: ") (proc 0) (str "I don't think I can use this here.") (proc 3)))))
 (seg (? (= Q 8))
