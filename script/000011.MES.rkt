(mes
 ...
 (seg*
  ...
  (proc 4) (str "Cole: ") (proc 0)
   (str "Huh? I'm back on the main floor, but Doc and Sheila" 'br)
   (str "aren't here...")
  (proc 3)
  ...
  (proc 3)
  (proc 4) (str "Cole: ") (proc 0)
   (str "Huh? Is that Sheila's voice? ...I think it's coming" 'br)
   (str "from that Resource Room over there.")
  (proc 3)
 ...
 (seg (? (= Q 9))
   (proc 4) (str "Cole: ") (proc 0)
    (str "Sheila's fine, I don't think she's dead. Her voice" 'br)
   (str "came from over there.")
   (proc 3))
 (seg (? (= Q 10))
   (proc 4) (str "Cole: ") (proc 0)
