(mes
 ...
 (seg*
  ...
  (sound '|| 0)
  (sound '|se | 10)
  (image-file "A:¥GRAPH¥BL017.GPC") (image-mem 1 1)
  (if (</>
  ...
  (text-reset 14)
  (if (</>
       (// (? (= 73 #t)) (proc 4) (str "Cole: ") (proc 0) (str "Seems to be the armory.") (proc 3))
       (//
        (? (= 73 #f) (= 74 #t))
        (proc 4) (str "Cole: ") (proc 0)
         (str "I smell gunpowder. This must be the armory. I" 'br)
   (str "shouldn't stay here for long. It's really dark.")
        (proc 3))
       (//
        (? (= 73 #f) (= 74 #f))
        (proc 4) (str "Cole: ") (proc 0)
         (str "Something reeks of gunpowder. This must be an armory." 'br)
   (str "It's so dark.")
        (proc 3))))
   ...
   (branch-var
    ...
    (</>
     (/
      ...
      (set-reg 73 #t)
      (proc 3))
     (/ (proc 4) (str "Cole: ") (proc 0) (str "On second thought...") (proc 3)))))
 ...
 (seg (? (= Q 9) (= 0 #f) (= 1 #t) (= 67 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "No weapons?! What can I do with all of the undead if" 'br)
   (str "I don't have a weapon?!")
   (set-reg 67 #t)
   (proc 3))
 (seg (? (= Q 9) (= 0 #f) (= 1 #t) (= 68 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "Not a single bullet or gun here. Even a little" 'br)
   (str "peashooter would make me feel better.")
   (set-reg 68 #t)
   (proc 3))
 (seg (? (= Q 9) (= 0 #f) (= 1 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (str "No matter how much I look, I can't find a single" 'br)
   (str "weapon.")
   (proc 3))
 ...
 (seg (? (= Q 10) (= 0 #f) (= 1 #t) (= 69 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "Is that blood on the floor? It goes to the back. Is" 'br)
   (str "someone there?")
   (set-reg 69 #t)
   (proc 3))
 ...
 (seg (? (= Q 11) (= 0 #f) (= 1 #t) (= 71 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "I think I see a desk back there, so maybe that's a" 'br)
   (str "different room?")
   (set-reg 71 #t)
   (proc 3))
 (seg (? (= Q 11) (= 0 #f) (= 1 #t) (= 72 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "The fact there's a massive trail of blood means" 'br)
   (str "something is back there, dead or undead. I should stay" 'br)
   (str "alert.")
   (set-reg 72 #t)
   (proc 3))
 (seg (? (= Q 11) (= 0 #f) (= 1 #t))
 ...
 (seg (? (= Q 6) (= 0 #t) (= 1 #t) (= 73 #t))
   ...
   (branch-var
    ...
    (</>
     ...
     (/ (proc 4) (str "Cole: ") (proc 0) (str "I'll look around a little more.") (proc 3)))))
