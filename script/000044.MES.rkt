(mes
 ...
 (seg*
  ...
  ((cmd 197) 0 0)
  ((cmd 197) 1 0)
  (image-file "A:¥GRAPH¥BL077A.GPC") (image-mem 1 1)
  (sound '|| 0)
  ...
  (if (</>
       (//
        ...
        (proc 4) (str "Sheila: ") (proc 2)
           (text "　")
        (str "The atmosphere feels so off.")
        (text "　")
        (set-reg 24 #t))
       (//
        (proc 4) (str "Sheila: ") (proc 2)
           (text "　")
        (str "I've never seen this painting before now.")
        (text "　"))))
  (proc 3)
 ...
 (seg (? (= Q 12) (= 0 #f) (= 26 #f))
   (proc 4) (str "Sheila: ") (proc 2)
      (str "Cole, we better hurry or we'll be late for our" 'br)
   (str "meeting with Cain.")
   (set-reg 26 #t)
   (proc 3))
 (seg (? (= Q 12) (= 0 #f))
   (proc 4) (str "Cole: ") (proc 0)
 ...
 (seg (? (= Q 11) (= 0 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "Oh no... It's so late. If I don't hurry, I'll be" 'br)
   (str "tardy to the meeting.")
   (proc 3))
 (seg (? (= Q 10) (= 0 #f) (= 28 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "This must be a picture of a great scholar, but I" 'br)
   (str "don't know who.")
   (set-reg 28 #t)
   (proc 3))
 (seg (? (= Q 10) (= 0 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "It's a row of portraits of famous scholars. Everyone" 'br)
   (str "in these photos looks so smart.")
   (proc 3))
 (seg (? (= Q 9) (= 0 #f) (= 29 #f))
   (proc 4) (str "Cole: ") (proc 0)
 ...
 (seg (? (= Q 9) (= 0 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "The lab was destroyed in Jack's rampage. Sheila will" 'br)
   (str "be upset if she sees what happened to Kitty.")
   (proc 3))
 (seg (? (= Q 12) (= 0 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (if (</>
   ...
   (mes-jump "A:¥MES¥000046.MES"))
 (seg (? (= Q 11) (= 0 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (if (</>
        (// (text "　") (str "Let's go into the study.") (text "　"))
        (// (text "　") (str "Let's check this room...") (text "　"))))
   (proc 3)
   ((cmd 198) 32 5 127 66 0)
   (mes-jump "A:¥MES¥000048.MES"))
 (seg (? (= Q 8))
