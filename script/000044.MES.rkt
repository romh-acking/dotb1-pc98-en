(mes
 ...
 (seg (? (= Q 12) (= 0 #f) (= 26 #f))
   (proc 2)
   (str
    "Cole, we better hurry or we'll be late for our     meeting with Cain.")
   (set-reg 26 #t)
   (proc 3))
 (seg (? (= Q 12) (= 0 #f))
   (proc 0)
 ...
 (seg (? (= Q 9) (= 0 #f))
   (proc 0)
   (str
    "The lab was destroyed in Jack's rampage. Sheila will be upset if she sees what happened to Kitty.")
   (proc 3))
 (seg (? (= Q 12) (= 0 #t))
   (proc 0)
   (if (</>
