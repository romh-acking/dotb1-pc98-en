(mes
 ...
 (seg*
  ...
  (if (</>
       ...
       (//
        (proc 4) (str "Cole: ") (proc 0)
         (str "I can't get over how many books are here. Doc was so" 'br)
   (str "into his research.")
        (proc 3))))
  (if (</>
 ...
 (seg (? (= Q 11) (= 0 #f) (= 1 #t) (= 64 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "It's windy out, so the trees are blowing noisily." 'br)
   (str "It'll be hard to hear if someone or something is outside.")
   (set-reg 64 #t)
   (proc 3))
 (seg (? (= Q 11) (= 0 #f) (= 1 #t))
   (proc 4) (str "Cole: ") (proc 0)
 ...
 (seg (? (= Q 14) (= 0 #f) (= 1 #t))
   ...
   (proc 4) (str "Cole: ") (proc 0)
    (str "Weird... the remote only seems to have 2 buttons," 'br)
   (str "Power and Open.")
   (set-reg 72 #t)
   (proc 3))
 ...
 (seg (? (= Q 15) (= 0 #f) (= 1 #t) (= 74 #f) (= 72 #f))
   ...
   (proc 3)
   (proc 4) (str "Cole: ") (proc 0)
    (str "This page seems to be a detailed description of the" 'br)
   (str "brain.")
   (set-reg 74 #t)
   (proc 3))
 ...
 (seg (? (= Q 15) (= 0 #t) (= 1 #f) (= 72 #t) (= 75 #t) (= 76 #f))
   ...
   (proc 3)
   (proc 4) (str "Cole: ") (proc 0)
    (str "Damn! You have to enter a passcode along with the" 'br)
   (str "key?")
   (proc 3)
   (proc 4) (str "Cole: ") (proc 0)
   ...
   (proc 3)
   (proc 4) (str "Cole: ") (proc 0)
    (str "Surely the key is for this safe though. I came all" 'br)
   (str "the way for this.")
   (set-reg 76 #t)
   (proc 3)
   (exec-mem 16384 0 0 1 1)
   (exec-mem 256 2)
