 ...
 (seg*
  ...
  (if (</>
       ...
       (//
        ...
        (proc 0)
        (str
         "I feel like I did Ray wrong by pulling the trigger.  Now I know how Nose felt.")
        (proc 3)
        (proc 1)
        (str
         "It can't be helped at all. When you turn, it's bestto die before you can hurt anyone else.")
        (set-reg 90 #t)
        (proc 3)
        ((cmd 212)))
       (//
