(mes
 ...
 (seg*
  (if (</>
       (//
        (? (= 500 #t) (= 501 #f))
        (image-file "A:¥GRAPH¥BL006.GPC")
        (image-mem 1 1)
        (image-file "A:¥GRAPH¥BL006F.GPC")
        (image-mem 1 1)
        (image-file "A:¥GRAPH¥BL006C.GPC")
        (image-mem 1 1)
        (exec-mem 10496 1 32 36 127 36 32 5 127 66 8 50)
        (repeat
         8
         (<>
          (image-file "A:¥GRAPH¥BL6CC.GPC")
          (image-mem 1 1)
          (delay 8 0)
          (image-file "A:¥GRAPH¥BL006C.GPC")
          (image-mem 1 1)
       ...
       (//
        ...
        (image-file "A:¥GRAPH¥BL006C.GPC")
        (image-mem 1 1)
        (image-file "A:¥GRAPH¥BL006B.GPC")
        (image-mem 1 1)
        (exec-mem 10496 1 32 36 127 36 32 5 127 66 8 50)
        (repeat
         8
         (<>
          (image-file "A:¥GRAPH¥BL6BB.GPC")
          (image-mem 1 1)
          (delay 8 0)
          (image-file "A:¥GRAPH¥BL006B.GPC")
          (image-mem 1 1)
       ...
       (//
        ...
        (image-file "A:¥GRAPH¥BL006B.GPC")
        (image-mem 1 1)
        (image-file "A:¥GRAPH¥BL006E.GPC")
        (image-mem 1 1)
        (exec-mem 10496 1 32 36 127 36 32 5 127 66 8 50)
        (repeat
         8
         (<>
          (image-file "A:¥GRAPH¥BL6EE.GPC")
          (image-mem 1 1)
          (delay 8 0)
          (image-file "A:¥GRAPH¥BL006E.GPC")
          (image-mem 1 1)
       ...
       (//
        ...
        (image-file "A:¥GRAPH¥BL006E.GPC")
        (image-mem 1 1)
        (image-file "A:¥GRAPH¥BL006A.GPC")
        (image-mem 1 1)
        (exec-mem 10496 1 32 36 127 36 32 5 127 66 8 50)
        (repeat
         8
         (<>
          (image-file "A:¥GRAPH¥BL6AA.GPC")
          (image-mem 1 1)
          (delay 8 0)
          (image-file "A:¥GRAPH¥BL006A.GPC")
          (image-mem 1 1)
       ...
       (//
        ...
        (image-file "A:¥GRAPH¥BL006A.GPC")
        (image-mem 1 1)
        (image-file "A:¥GRAPH¥BL006D.GPC")
        (image-mem 1 1)
        (exec-mem 10496 1 32 36 127 36 32 5 127 66 8 50)
        (repeat
         8
         (<>
          (image-file "A:¥GRAPH¥BL6DD.GPC")
          (image-mem 1 1)
          (delay 8 0)
          (image-file "A:¥GRAPH¥BL006D.GPC")
          (image-mem 1 1)
