(mes
  ...
  (if (</>
       (//
        ...
        (proc 4) (str "Cole: ") (proc 0)
         (str "It's a hallway... Has Doc's house always been this" 'br)
   (str "creepy?")
        (set-reg 24 #t)
        (proc 3))
       (// (proc 4) (str "Cole: ") (proc 0) (str "Doc's house seems well made.") (proc 3))))
 ...
 (seg (? (= Q 9) (= 0 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "The lab was messed up by Jack's rampage. I don't want" 'br)
   (str "to go in there and see that dead cat again.")
   (proc 3))
 (seg (? (= Q 12) (= 0 #t))
   (proc 4) (str "Cole: ") (proc 0)
    (if (</>
