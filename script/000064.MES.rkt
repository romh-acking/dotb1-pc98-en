(mes
 ...
 (seg*
  ...
  ((cmd 197) 0 0)
  ((cmd 197) 1 0)
  (image-file "A:¥GRAPH¥BL108.GPC") (image-mem 1 1)
  (sound '|| 0)
  (sound '|se | 16)
 ...
 (seg (? (= Q 9) (= 0 #f) (= 10 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "Lots of instruments are lined up. Must be for various" 'br)
   (str "experiments.")
   (set-reg 10 #t)
   (proc 3))
 (seg (? (= Q 9) (= 0 #f) (= 11 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "So many monitors, but I can't figure out what they're" 'br)
   (str "used for.")
   (proc 3)
   (proc 4) (str "Sheila: ") (proc 2)
 ...
 (seg (? (= Q 9) (= 0 #f))
   ...
   (proc 3)
   (proc 4) (str "Cole: ") (proc 0)
    (str "It seems this device runs day in and day out. Ghoul" 'br)
   (str "probably doesn't control this manually.")
   (set-reg 12 #t)
   (proc 3))
 (seg (? (= Q 10) (= 0 #f) (= 13 #f))
   (proc 4) (str "Cole: ") (proc 0)
 ...
 (seg (? (= Q 10) (= 0 #f) (= 14 #f))
   (proc 4) (str "Sheila: ") (proc 2)
      (str "It seems to be positive or negative depending on" 'br)
   (str "the relation to zero.")
   (proc 3)
   (proc 4) (str "Cole: ") (proc 0)
 ...
 (seg (? (= Q 11) (= 0 #f) (= 15 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "I guess this is where you sit and control the thing." 'br)
   (str "You must be an expert to operate this, probably.")
   (set-reg 15 #t)
   (proc 3))
 (seg (? (= Q 11) (= 0 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "This chair is firmly fastened to the floor. I can't" 'br)
   (str "move it at all.")
   (proc 3))
 (seg (? (= Q 12) (= 0 #f) (= 16 #f))
   (proc 4) (str "Cole: ") (proc 0)
   ...
   (proc 3)
   (proc 4) (str "Cole: ") (proc 0)
    (str "I want to pull them, but they'll probably do" 'br)
   (str "something bad.")
   (proc 3)
   (proc 4) (str "Sheila: ") (proc 2)
 ...
 (seg (? (= Q 13) (= 0 #f))
   (proc 4) (str "Cole: ") (proc 0)
    (str "I wonder if this glass is bulletproof like the other" 'br)
   (str "glass earlier.")
   (set-reg 19 #t)
   (proc 3))
 (seg (? (= Q 8))
