(mes
 ...
 (seg (? (= Q 9) (= 0 #f) (= 1 #t) (= 20 #f))
   (proc 0)
   (str
    "Sally, she gave me a call earlier. Her explanation   was great yesterday.")
   (set-reg 20 #t)
   (proc 3))
 (seg (? (= Q 9) (= 0 #f) (= 1 #t) (= 21 #f) (= 40 #f))
   (proc 0)
   (str
    "Wait a moment. Wasn't there another woman here       besides Sally yesterday?")
   (proc 3)
   (proc 0)
 ...
 (seg (? (= Q 10) (= 0 #f) (= 1 #t) (= 22 #f))
   (proc 0)
   (str
    "Yesterday, Killer had me at gunpoint. If I was just alittle more jumpy, that would've ended poorly.")
   (set-reg 22 #t)
   (proc 3))
 (seg (? (= Q 10) (= 0 #f) (= 1 #t) (= 23 #f))
   (proc 0)
   (str
    "Speaking of, I think Killer said he was a detective  at the 16th Precinct? Maybe Ghoul was his boss?")
   (set-reg 23 #t)
   (proc 3))
 (seg (? (= Q 10) (= 0 #f) (= 1 #t))
   (proc 0)
 ...
 (seg (? (= Q 11) (= 0 #f) (= 1 #t) (= 25 #f))
   (proc 0)
   (str
    "If it weren't for this situation, I wouldn't have metthe police chief.")
   (set-reg 25 #t)
   (proc 3))
 (seg (? (= Q 11) (= 0 #f) (= 1 #t) (= 26 #f))
   (proc 0)
   (str
    "I'm glad he's a nice guy. I was a bit worried they   would task me with killing 100 zombies today.")
   (set-reg 26 #t)
   (proc 3))
 (seg (? (= Q 11) (= 0 #f) (= 1 #t))
   (proc 0)
 ...
 (seg (? (= Q 12) (= 0 #f) (= 1 #t) (= 27 #f))
   (proc 0)
   (str
    "Nose is nicer than it seems. He came to me yesterday to talk about Ray.")
   (set-reg 27 #t)
   (proc 3))
 (seg (? (= Q 12) (= 0 #f) (= 1 #t) (= 28 #f))
   (proc 0)
   (str
    "He seems to be the strongest of us all. I would not  want to get on his bad side. Heh.")
   (set-reg 28 #t)
   (proc 3))
 (seg (? (= Q 12) (= 0 #f) (= 1 #t))
   (proc 0)
   (str
    "Nose promised me a big meal. Can't wait until this isall over. I'm hungry.")
   (proc 3))
 (seg (? (= Q 13) (= 0 #f) (= 1 #t) (= 29 #f))
   (proc 0)
   (str
    "I thought Nose would be a rough one, but he really   seemed to care about Ray.")
   (set-reg 29 #t)
   (proc 3))
 ...
 (seg (? (= Q 13) (= 0 #f) (= 1 #t))
   (proc 0)
   (str
    "I feel bad for Ray. I probably shouldn't tell him    about what happened yesterday.")
   (proc 3))
 (seg (? (= Q 14) (= 0 #f) (= 1 #t))
   (proc 0)
   (str
    "It's a large whiteboard. Nothing's written there     because we haven't written anything down.")
   (proc 3))
 (seg (? (= Q 15) (= 0 #f) (= 1 #t))
   (proc 0)
   (str
    "Nice conference desk. I've never seen one like it,   even in my own office.")
   (proc 3))
 (seg (? (= Q 9) (= 0 #t) (= 1 #f))
 ...
 (seg (? (= Q 6) (= 0 #f) (= 1 #f))
   ...
   (branch-var
    ...
    (</>
     ...
     (/ (proc 0) (str "I'll stay here for a little longer.") (proc 3)))))
 (seg (? (= Q 8))
