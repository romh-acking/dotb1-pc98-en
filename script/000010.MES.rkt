(mes
 ...
 (seg (? (= Q 10) (= 0 #f) (= 1 #t) (= 79 #f))
   (proc 0)
   (str "There's a lot of dust on this shelf, so it's probablynot used often.")
   (set-reg 79 #t)
   (proc 3))
 (seg (? (= Q 10) (= 0 #f) (= 1 #t))
   (proc 0)
 ...
 (seg (? (= Q 12) (= 0 #f) (= 1 #t) (= 81 #f))
   (proc 0)
   (str "The windows have blinds. Small ones, for small       windows.")
   (set-reg 81 #t)
   (proc 3))
 (seg (? (= Q 12) (= 0 #f) (= 1 #t))
   (proc 0)
   (str
    "They say that if you stare long enough into the      blinds, the blinds stare back at you.")
   (proc 3))
 (seg (? (= Q 6) (= 0 #t) (= 1 #t))
   ...
   (branch-var
    ...
    (</>
     ...
     (/ (proc 0) (str "Let's investigate some more.") (proc 3)))))
 (seg (? (= Q 8))
